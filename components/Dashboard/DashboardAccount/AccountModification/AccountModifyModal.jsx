...
const AccountModifyModal = ({
    ...
    if (IsFormValid()) {
      ...
      try {
        const response = await axios.patch(
          "https://0zwhtezm4f.execute-api.ap-south-1.amazonaws.com/TryItFirst/profile/info",
          fields
        );
  ...
  const HandleSubmit_Pass = async (event) => {
    ...
    if (IsFormValid()) {
      ...
      try {
        const response = await axios.patch(
          "https://0zwhtezm4f.execute-api.ap-south-1.amazonaws.com/TryItFirst/profile/password",
          fields
        );
  ...
  const HandleSubmit_Photo = async (event) => {
    ...
    try {
      const response = await axios.patch(
        "https://0zwhtezm4f.execute-api.ap-south-1.amazonaws.com/TryItFirst/profile/pic",
        apiData
      );
